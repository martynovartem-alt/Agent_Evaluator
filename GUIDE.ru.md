...
Вывод: **процент согласия** + матрица ошибок 3×3 (человек × судья), а также
`runs/<ts>/disagreements.csv` со всеми строками, где судья и человек разошлись, — с
обоснованием судьи рядом с комментарием человека. Используйте этот CSV, чтобы улучшать
