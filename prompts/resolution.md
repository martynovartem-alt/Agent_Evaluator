...
Output: {"verdict":"yes","failure_reason":"none","reasoning":"Core correct — right operation and charge, matches the operator. Less detail on benefits/cancellation, but accurate and useful."}
...
Output: {"verdict":"partial","failure_reason":"incomplete","reasoning":"Finds the right operation but doesn't address why cashback wasn't credited — only partly useful."}
...
Output: {"verdict":"no","failure_reason":"wrong_operation","reasoning":"Misidentifies a debt collection as an internal transfer — factually wrong and misleading."}
